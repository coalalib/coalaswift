...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication,
        ...
        let coala = Coala(port: 6789)
        let message = CoAPMessage(type: .Confirmable, code: .MethodCode(.GET))
        coala.send(message)
        return true
    }
    ...
    func applicationWillResignActive(application: UIApplication) {
        ...
        // for certain types of temporary interruptions (such as an incoming phone call
